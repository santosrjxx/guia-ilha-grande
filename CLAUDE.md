...
## Regras Inegociáveis:
1. Siga todas as diretrizes detalhadas no arquivo .cursorrules.
2. Toda a arquitetura deve ser Astro SSG Estático.
3. Foco total em Core Web Vitals (LCP < 1.2s) e SEO Técnico.
